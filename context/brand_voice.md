...
An autonomous gold savings engine. Users define a rule once — DCA, price trigger, or goal — and Auric executes it silently in the background, settling USDT into XAU₮ on-chain via Tether's WDK. Primary channel: Telegram bot. Primary market: LATAM.
...
**Write like a very good private banker who also happens to be technically literate.**

- Short sentences. One idea per sentence.
- Active voice always. "Auric bought" not "XAU₮ was purchased."
- Present tense for state, past tense for completed actions.
- Specificity over generality. "Bought 0.012 XAU₮ at $3,241" not "your order was filled."
- No hedging. No "might", "could", "hopefully." Either it happened or it will.
...
**1. Confirm outcomes, not intentions.**
Say what happened. Don't say what Auric is "trying" to do.

**2. Use the user's language.**
In LATAM context: "ahorro en oro" (gold savings), not "portfolio diversification into uncorrelated assets."

**3. Gold is the anchor, not a feature.**
Gold is why this exists. Reference it with weight — XAU₮ in UI, "gold" in copy.

**4. Never oversell autonomy.**
"Set it once" is true. "Never think about it again" is not — users still fund wallets, still set rules. Be accurate.

**5. Numbers are the story.**
The most compelling copy Auric can write is a trade confirmation with a real number. Let the data speak.
...
- **Product name:** Auric (capitalized, no descriptor needed)
- **Asset:** XAU₮ (tether gold ticker, always with ₮)
- **Engine noun:** "Auric" — not "the bot", not "the platform"
- **In Telegram:** Auric speaks in first person: "I bought…", "I'm monitoring…"
