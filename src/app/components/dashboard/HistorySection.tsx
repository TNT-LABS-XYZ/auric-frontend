              ...
              {executions.map((ex, i) => {
                ...
                return (
                  <tr
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "rgba(0,0,0,.01)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    {isWithdrawal ? (
                      <>
                        <td style={monoStyle}>
                          −
                          {f6(ex.amount_spent).toFixed(
                            ex.token === "xaut" ? 3 : 2,
                          )}{" "}
                          {(ex.token ?? "usdt").toUpperCase()}
                        </td>
                        <td
                          style={{
                            ...tdStyle,
