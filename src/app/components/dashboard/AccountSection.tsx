          ...
          >
            <div
              style={{
                ...
                padding: 16,
                boxShadow:
                  "0 0 0 1px rgba(0,0,0,.06), 0 2px 8px rgba(0,0,0,.04)",
              }}
            >
            ...
            >
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12 3v7.5l6 3L12 3z" fill="#fff" fillOpacity=".6" />
                <path d="M12 3l-6 10.5 6-3V3z" fill="#fff" />
                <path
                  d="M12 16.5v4.5l6-8.5-6 4z"
                  fill="#fff"
                  fillOpacity=".6"
                />
                <path d="M12 21v-4.5L6 12.5 12 21z" fill="#fff" />
              </svg>
              <span
                style={{
                  fontSize: 11,
      ...
      mcpServers: {
        auric: {
          ...
          args: [
            "-y",
            "mcp-remote",
            "https://auric-backend-production.up.railway.app/mcp",
            "--header",
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          >
            ...
            {tooltipVisible && (
              ...
              >
                This token expires after 30 days and rotates when you log out
                and back in. If your MCP connection stops working, re-copy this
                config with your new token.
              </span>
            )}
          </span>
          <button
      ...
      {!visible ? (
        ...
        >
          ...
          >
            This config contains your auth token. Treat it like a password —
            don&apos;t share it. Click the eye icon to reveal.
          </p>
        </div>
      ) : (
        <pre
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            {TELEGRAM_BOT && (
              <a
                href={
                  !telegramLinked && telegramToken
                    ? `https://t.me/${TELEGRAM_BOT}?start=${telegramToken}`
